...
{% comment %}
satu aksara tertentu ditambah pada permulaan setiap baris
istilah--kecuali simbol--membolehkan carian pantas dibuat
menggunakan fungsi terbina pelayar web, sekaligus dapat
mengira bilangan istilah dalam laman ini tanpa kod tambahan
{% endcomment %}
...
: aksara yang menjadi kekunci pintas terbina pada pelayar
web dan pemapar fail lain untuk membuat carian pantas
